...
class OAuthSonos extends WebOAuthModule
{
	...
	public function Testing()
	{
		...
		*/
		...
		$api_endpoint = "/control/api/v1/households";
		$api_endpoint = "/api/v1/households";
		$api_endpoint = "/v1/households";
